...
public class yougo16 extends JDialog {
	...
	private yougo29 y8 = new yougo29();
	public int count = 0;
	...
	public yougo16() {
		...
		lblNewLabel = new JLabel("<html>インターネットを通じて情報システムの稼働に必要なサーバ、<br>CPU、ストレージ、ネットワークなどのインフラを利用する形態のことは？</html>");
		...
		kaisetuLabel.setFont(new Font("MS UI Gothic", Font.PLAIN, 14));
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解は「IaaS」<br>SaaS = Software as a Service<br>IaaS = Infrastructure as a Service<br>PaaS = Platform as a Service<br>DaaS = Desktop as a Service</html>");
						}
