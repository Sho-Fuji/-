...
public class gra16 extends JDialog {
	...
	public gra16() {
		...
		lblNewLabel = new JLabel("「確認する」の謙譲語は？？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>正解です。<br>「確認します」は丁寧語であり、謙譲語は存在しない。</html>");
							...
							kaisetuLabel.setText("<html>不正解です。正解は「改める」である。<br>「確認します」は丁寧語であり、謙譲語は存在しない。</html>");
