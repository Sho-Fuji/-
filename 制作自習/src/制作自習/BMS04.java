...
public class BMS04 extends JDialog {
	...
	public BMS04() {
		...
		lblNewLabel = new JLabel("<html>階段・エスカレーターで上がるとき、お客様を案内するのにどの立ち位置がふさわしいか<br>※お客様、案内者はどちらも男性とする</html>");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解は「後ろ側」<br>お客様より低い位置で案内するため、案内者は後で上がる</html>");
