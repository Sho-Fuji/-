...
public class yougo20 extends JDialog {
	...
	public yougo20() {
		...
		lblNewLabel = new JLabel("「アジェンダ」の意味は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。<br>英語では「agenda」と書き、協議事項、議事日程、予定表などと訳される。</html>");
