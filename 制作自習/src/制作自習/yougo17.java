...
public class yougo17 extends JDialog {
	...
	public yougo17() {
		...
		lblNewLabel = new JLabel("<html>インターネットを通じてアプリケーションソフトウェアが<br>稼働するためのハードウェアやOSなどの基盤を利用する形態は？</html>");
