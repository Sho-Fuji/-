...
public class yougo18 extends JDialog {
	...
	public yougo18() {
		...
		lblNewLabel = new JLabel("<html>インターネットを通じてデスクトップ環境を利用する形態は？<br></html>");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解は「DaaS」<br>SaaS = Software as a Service<br>IaaS = Infrastructure as a Service<br>PaaS = Platform as a Service<br>DaaS = Desktop as a Service</html>");
						}
