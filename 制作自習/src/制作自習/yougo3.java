...
public class yougo3 extends JDialog {
	...
	private yougo30 y6 = new yougo30();
	public int count=0;
	...
	public yougo3() {
		...
		lblNewLabel = new JLabel("最高情報責任者は？");
		...
		ARadioButton = new JRadioButton("CTO");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解は「CIO」<br>CEO = Chief Executive Officer = 最高経営責任者<br>CIO = Chief Information Officer = 最高情報責任者<br>COO = Chief Operations Officer = 最高執行責任者<br>CTO = Chief Technology Officer = 最高技術責任者</html>");
						}
