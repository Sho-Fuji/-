...
public class yougo31 extends JDialog {
	...
	public yougo31() {
		...
		lblNewLabel = new JLabel("「マスト」の意味は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。<br>「must」からできたカタカナ用語で<br>”絶対に達成しなくてはならない”ノルマという意味</html>");
