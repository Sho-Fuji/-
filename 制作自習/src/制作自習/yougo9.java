...
public class yougo9 extends JDialog {
	...
	public yougo9() {
		...
		lblNewLabel = new JLabel("Web技術の標準化を行う団体は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解は「W3C」<br>ISO = International Organization for Standardization<br>IEC = International Electrotechnical Commission<br>IEEE = the Institute of Electrical and Electronics Engineers<br>W3C = World Wide Web Consortium</html>");
						}
