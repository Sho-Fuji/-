...
public class BMS11 extends JDialog {
	...
	public BMS11() {
		...
		lblNewLabel = new JLabel("<html>手紙の時候の挨拶として２月に当てはまるものはどれ</html>");
		...
		ARadioButton = new JRadioButton("厳冬の候");
		...
		CRadioButton = new JRadioButton("春寒の候");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>正解は「春寒の候」<br>「厳冬の候」は1月の挨拶であり、「浅春の候」「春分の候」は3月の挨拶である</html>");
							...
							kaisetuLabel.setText("<html>「厳冬の候」は1月の挨拶であり、「浅春の候」「春分の候」は3月の挨拶である</html>");
