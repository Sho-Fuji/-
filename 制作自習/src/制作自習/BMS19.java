...
public class BMS19 extends JDialog {
	...
	public BMS19() {
		...
		lblNewLabel = new JLabel("<html>不祝儀袋において仏式の場合水引きの色として正しいものはどれ</html>");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>正解は「黒白」<br>仏式の場合は「黒白」、「白」「銀」は神式の場合。また、神式で「黒白」を使うこともできる</html>");
