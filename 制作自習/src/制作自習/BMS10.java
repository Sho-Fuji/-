...
public class BMS10 extends JDialog {
	...
	public BMS10() {
		...
		lblNewLabel = new JLabel("<html>社外文書において実務文書であり、社交文書でもあるのはどれ</html>");
