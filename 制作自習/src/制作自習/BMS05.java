...
public class BMS05 extends JDialog {
	...
	public BMS05() {
		...
		lblNewLabel = new JLabel("<html>階段・エスカレーターで下りるとき、お客様を案内するのにどの立ち位置がふさわしいか<br>※お客様、案内者はどちらも男性とする</html>");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>正解です。<br>お客様より低い位置で案内するため、案内者は先に下りる</html>");
							MessageLabel.setText("〇 正解");
							MessageLabel.setForeground(Color.RED);
							count+=1;
						}
						else if(BRadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解は「前側」<br>お客様より低い位置で案内するため、案内者は先に下りる</html>");
