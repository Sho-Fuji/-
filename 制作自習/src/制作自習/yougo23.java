...
public class yougo23 extends JDialog {
	...
	public yougo23() {
		...
		lblNewLabel = new JLabel("「ブラッシュアップ」の意味は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。<br>ビジネスでは、提案やアイデアをブラッシュアップしてより洗練したものにする、といった意味で使われる。</html>");
							...
							kaisetuLabel.setText("<html>正解です。<br>ビジネスでは、提案やアイデアをブラッシュアップしてより洗練したものにする、といった意味で使われる。</html>");
							count+=1;
						}			
