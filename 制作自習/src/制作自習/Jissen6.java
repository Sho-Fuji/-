...
public class Jissen6 extends JDialog {
	...
	public Jissen6() {
		...
		lblNewLabel = new JLabel("次の敬語のうち、正しいものはどれでしょうか？");
		...
		ARadioButton = new JRadioButton("今日、取引先のＥ社長が参上します");
		ARadioButton.setFont(new Font("UD デジタル 教科書体 N-B", Font.PLAIN, 12));
		ARadioButton.setSelected(true);
		panel.add(ARadioButton);
		
		BRadioButton = new JRadioButton("今日、取引先のＥ社長がおいでになります");
		BRadioButton.setFont(new Font("UD デジタル 教科書体 N-B", Font.PLAIN, 12));
		panel.add(BRadioButton);
		
		CRadioButton = new JRadioButton("今日、取引先のＥ社長が参ります");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(BRadioButton.isSelected()) {
							kaisetuLabel.setText("<html>正解です。<br>取引先の社長の動作に尊敬語を用います。「参る」「参上する」はともに謙譲語です。</html>");
							MessageLabel.setText("〇 正解 ");
							MessageLabel.setForeground(Color.RED);
						}
						else if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。取引先の社長の動作に尊敬語を用います。「参る」「参上する」はともに謙譲語です。</html>");
