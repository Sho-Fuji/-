...
public class yougo15 extends JDialog {
	...
	public yougo15() {
		...
		lblNewLabel = new JLabel("<html>インターネットを通じて配信されるソフトウェアを利用する形態のことは？<br></html>");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							...
							kaisetuLabel.setText("<html>不正解です。正解は「SaaS」<br>SaaS = Software as a Service<br>IaaS = Infrastructure as a Service<br>PaaS = Platform as a Service<br>DaaS = Desktop as a Service</html>");
						}
