...
public class BMS20 extends JDialog {
	...
	public BMS20() {
		...
		lblNewLabel = new JLabel("<html>不祝儀袋においてキリスト教の場合水引きの色として正しいものはどれ</html>");
		...
		kaisetuLabel.setFont(new Font("MS UI Gothic", Font.PLAIN, 13));
