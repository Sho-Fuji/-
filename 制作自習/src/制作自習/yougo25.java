...
public class yougo25 extends JDialog {
	...
	public yougo25() {
		...
		lblNewLabel = new JLabel("「ペンディング」の意味は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>正解です。<br>保留以外にも延期、先延ばし、再検討という意味でも使われる。</html>");
							count+=1;
							
						}
						else if(BRadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。<br>保留以外にも延期、先延ばし、再検討という意味でも使われる。</html>");
