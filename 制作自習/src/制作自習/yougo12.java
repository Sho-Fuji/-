...
public class yougo12 extends JDialog {
	...
	public yougo12() {
		...
		lblNewLabel = new JLabel("<html>PPM分析(Product Portfolio Management)の中で<br>市場成長率が低く、市場占有率が高いのは？</html>");
