...
public class yougo21 extends JDialog {
	...
	public yougo21() {
		...
		lblNewLabel = new JLabel("「バイアス」の意味は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。<br>「傾斜」という意味から「偏っている」という意味に派生した。</html>");
