				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(CRadioButton.isSelected()) {
							kaisetuLabel.setText("<html>正解です。<br>「「誰」の尊敬語は「どなた」である。</html>");
							MessageLabel.setText("〇 正解 ");
							MessageLabel.setForeground(Color.RED);
						}
						else if(BRadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解はどなた」である。「どちら様」「どなた様」は敬語表現のあとに敬称である「様」が続くため、二重敬語となり間違いなのです。</html>");
							MessageLabel.setText("× 不正解");
						}
						else if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。正解は「どなた」である。「どちら様」「どなた様」は敬語表現のあとに敬称である「様」が続くため、二重敬語となり間違いなのです。</html>");
							MessageLabel.setText("× 不正解");
						}
