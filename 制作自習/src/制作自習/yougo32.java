...
public class yougo32 extends JDialog {
	...
	public yougo32() {
		...
		lblNewLabel = new JLabel("「メソッド」の意味は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。<br>目標を達成するために決められたやり方、<br>方法、方式、ノウハウといった意味で使われる</html>");
							...
							kaisetuLabel.setText("<html>正解です。<br>目標を達成するために決められたやり方、<br>方法、方式、ノウハウといった意味で使われる</html>");
