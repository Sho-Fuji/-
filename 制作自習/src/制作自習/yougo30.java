...
public class yougo30 extends JDialog {
	...
	private yougo23 y7 = new yougo23();
	public int count=0;
	...
	public yougo30() {
		...
		lblNewLabel = new JLabel("「ペルソナ」の意味は？");
				...
				AnswerButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(ARadioButton.isSelected()) {
							kaisetuLabel.setText("<html>不正解です。<br>相手がどういった人かの人物像を設定することとして使われる</html>");
							...
							kaisetuLabel.setText("<html>正解です。<br>相手がどういった人かの人物像を設定することとして使われる</html>");
							count+=1;
						}			
